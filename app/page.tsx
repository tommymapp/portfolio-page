      ...
      <AnimatedHeader variant="hero">
        <section className="h-full w-full flex flex-col-reverse flex-reverse md:flex-row justify-center gap-10 md:gap-12 items-center relative">
          ...
          <div className="relative">
              <Image src="/selfie.jpg" alt="Tommy looking extremeley cool" width="300" height="150" className="border-4 border-secondary-500 w-60 h-60 sm:w-70 h-70 md:w-80 md:h-80 object-cover md:min-w-80 shadow-xl rounded-3xl"/>
