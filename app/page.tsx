      ...
      <AnimatedHeader variant="hero">
        <section className="h-full w-full flex flex-col-reverse flex-reverse md:flex-row justify-center gap-10 md:gap-12 items-center relative md:px-8">
          <div className="">
            ...
            <a className="absolute bottom-0 left-1/2 -translate-x-1/2 mb-4 text-lg cursor-pointer" onClick={() => document.getElementById('howIHelp')?.scrollIntoView({ behavior: 'smooth' })}>
               <FaArrowDown className="inline h-6 w-6 mr-1.5"/> Learn more
            </a>
          </div>
          
          <div className="relative">
              <Image src="/selfie.jpg" alt="Tommy looking extremeley cool" width="300" height="150" className="border-4 border-secondary-500 w-70 h-70 md:w-80 md:h-80 object-cover md:min-w-80 shadow-xl rounded-3xl"/>
